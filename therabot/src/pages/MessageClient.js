...
function MessageClient({ messages, setMessages }) {
        ...
        <div className="flex flex-col h-screen justify-between items-center  z-10 relative">
          <div className="flex justify-center items-center relative text-4xl sm:text-5xl font-bold text-white z-20 pt-4 md:pt-8 ">
            <div className="flex items-center mr-20 ">
              ...
              <CircleIcon
                className="scale-75 ml-2 w-14 h-14 sm:w-24 sm:h-24 dark:bg-gray-600 "
              ...
              <div className="ml-2 text-center flex flex-col items-start sm:pt-2">
                <span className="text-2xl sm:text-5xl ">John Smith</span>
              ...
              {messages.map((message, index) => (
                ...
                >
                  {message.sender === "therapist" && (
                    <CircleIcon
                      className="scale-75 w-14 h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 dark:text-white dark:bg-gray-600"
          ...
          <div className="absolute bottom-0 sm:w-screen flex justify-center">
            <div className="fixed inset-x-0 bottom-0 p-4 md:p-6 bg-white  dark:bg-gray-700 flex items-center rounded-t-3xl shadow">
              <input
                type="text"
                value={newMessage}
                ...
                className="dark:placeholder-white dark:text-white md:text-xl flex-grow p-2 md:p-4 mr-4 rounded-full border-2  dark:bg-gray-600 border-gray-300 dark:border-white outline-BACKGROUND_BLUE dark:outline-sky-700"
              />
              <button
                onClick={sendMessage}
                className="p-2 md:p-4 rounded-full bg-BACKGROUND_BLUE dark:bg-sky-700 text-white  shadow-lg flex-shrink-0"
              >
