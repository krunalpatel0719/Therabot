...
function ScheduleAppointment({setNotifications}) {
  ...
  return (
    <div className="bg-gradient-to-b from-BACKGROUND_BLUE to-white min-h-screen">
      <div className="overflow-x-hidden relative flex justify-center items-center  w-screen ">
        ...
        <div className="flex flex-col  h-auto  justify-start items-center  z-10 relative">
          ...
          <div className="flex flex-col justify-center items-center mt-20 mb-8 md:mt-32 lg:mb-16  lg:mt-40">
            <div className=" rounded-2xl border-2 border-black drop-shadow-xl shadow-xl bg-white  p-4 ">
              <Calendar
          ...
          <div className=" lg:text-3xl mb-4 px-4 pb-4 pt-2 lg:py-6 lg:px-6  bg-white border-2 border-black rounded-2xl shadow-lg flex flex-col justify-center items-center">
            <h2 className=" font-semibold mb-4 lg:mb-6  border-b-black border-b-2 w-full text-center pb-2 lg:pb-6 ">
              Select Time
            </h2>
          ...
          <div className="fixed bottom-0 lg:bottom-4 left-0 right-0 mx-4 my-4 ">
            <button
              className="scale-90 w-full px-24 sm:px-324 p-4 bg-blue-500 text-white rounded-full font-semibold text-xl sm:text-3xl lg:text-4xl"
